...
@mcp_tool(
    description=(
        "Return full schema for one sfcrm Salesforce CRM table: every "
        "column with its data type, nullability, primary/foreign key "
        "flags, semantic tags, description, and an example value. Use "
        "this before writing a query against the table to ensure column "
