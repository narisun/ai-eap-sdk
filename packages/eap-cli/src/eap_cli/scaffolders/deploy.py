...
async def invocations(req: InvocationRequest) -> InvocationResponse:
    try:
...
def package_agentcore(
    ...
    *,
    ...
    (out / "handler.py").write_text(_AGENTCORE_HANDLER.format(entry=entry))
...
def package_vertex_agent_engine(
    ...
    *,
    ...
    (out / "handler.py").write_text(_VERTEX_HANDLER.format(entry=entry))
